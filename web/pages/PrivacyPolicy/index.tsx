...
- Affiliates: We may disclose Personal Information to our affiliates, meaning an entity that controls, is controlled by, or is under common control with Vicha. Our affiliates may use the Personal Information we share in a manner consistent with this Privacy Policy. 
...
You can exercise some of these rights through your Vicha account. If you are unable to exercise your rights through your account, please send your request in our [discord server ("https://agnai.chat/discord")](https://agnai.chat/discord).
...
Our Service is not directed to children who are under the age of 18. Vicha does not knowingly collect Personal Information from children under the age of 18. If you have reason to believe that a child under the age of 18 has provided Personal Information to Vicha through the Service please contact us on our [discord server ("https://agnai.chat/discord")](https://agnai.chat/discord). We will investigate any notification and if appropriate, delete the Personal Information from our systems.

## 7. Links to other websites

The Service may contain links to other websites not operated or controlled by Vicha, including social media services ("Third Party Sites"). The information that you share with Third Party Sites will be governed by the specific privacy policies and terms of service of the Third Party Sites and not by this Privacy Policy. By providing these links we do not imply that we endorse or have reviewed these sites. Please contact the Third Party Sites directly for information on their privacy practices and policies. 
...
const PrivacyPolicyPage: Component = () => {
  return (
    <div>
      <PageHeader title={<>Vicha Privacy Policy</>} />
