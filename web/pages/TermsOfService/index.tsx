...
## Thank you for using Vicha!

Vicha (hereafter known as the Stakeholders) provide Services to you subject to these terms.
...
const TermsOfServicePage: Component = () => {
  return (
    <div>
      <PageHeader title={<>Vicha Terms of Service</>} />
